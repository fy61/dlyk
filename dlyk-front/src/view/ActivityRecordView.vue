        ...
        activitySubmit() {
            ...
            for (let field in this.activityQuery) {
                ...
                if (this.activityQuery[field]) {
                    //this.activityQuery[field]有值，this.activityQuery[field]不是空，this.activityQuery[field]存在
                    formData.append(field, this.activityQuery[field]);
                }
            }

            this.$refs.activityRefFrom.validate((isValid) => {
                if (isValid) {
