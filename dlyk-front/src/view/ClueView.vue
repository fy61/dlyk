<template>
    <el-button type="primary" class="btn" @click="addClue" v-hasPermission="'clue:add'"
        >录入线索</el-button
    >
    <el-button
        type="success"
...
export default defineComponent({
    ...
    methods: {
        ...
        uploadFile(param) {
            ...
            formData.append('file', fileObj); //文件对象，前面file是参数名，后面fileObj是参数值,前后端字段名需要相同
